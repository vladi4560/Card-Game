...
export default class MainScene extends Phaser.Scene {
	...
	private time_txt!: Phaser.GameObjects.Text;
  	private countdownTimer!: Phaser.Time.TimerEvent;

	private leaderboardFifth!: Phaser.GameObjects.Text;
	private leaderboardFourth!: Phaser.GameObjects.Text;
	private leaderboardThird!: Phaser.GameObjects.Text;
	private leaderboardSecond!: Phaser.GameObjects.Text;
	private leaderboardFirst!: Phaser.GameObjects.Text;
	...
	setFeedBackTextVisible(value:boolean){
		this.feedBackTxt.visible = value;
	}
	setTurnText(turnNum:number){
		this.turn_txt.setText("Turns Left:"+turnNum);
	}
	gameOverMessage(gameResult: string){
